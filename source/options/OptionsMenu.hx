...
class OptionsMenu extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (config.getpractice()){package options;
...
class OptionsMenu extends MusicBeatState
{
	...
	var menuItems:Array<String> = ['controls', 'set fps', 'downscroll: off', 'practice: off', 'full combo mode: off', 'Optimization: off', 'Not available', 'About'];
	var _pad:FlxVirtualPad;
	...
	override function create()
	{
		...
		if (config.getoptimize()){
		    menuItems[menuItems.indexOf('Optimization: off')] = 'Optimization: on';
		}
	...
	override function update(elapsed:Float)
	{
		...
		if (ACCEPT)
		{
			...
			switch (daSelected)
			{
				...
				case "Optimization: on" | "Optimization: off":
				    FlxG.resetState();
