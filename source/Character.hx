	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				animation.addByPrefix('singDOWN', 'GF Down Note', 24, false);bfHoldingGF-DEAD.pngpackage;
...
class Character extends FlxSprite
{
    ...
    var optimize_isenabled:Bool = false;
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
		    if (optimize_isenabled)
		    {
		        case 'gf':
		    		// GIRLFRIEND CODE
			    	switch PlayState.SONG.song.toLowerCase() {
			    		case 'bopeebo':
				    		tex = Paths.getSparrowAtlas('GF_assetsOPT');
				    	default:
			...
			case 'trickymask':
				...
				tex = Paths.getSparrowAtlas('characters/TrickyMask');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24);
				animation.addByPrefix('singUP', 'Sing Up', 24);
				animation.addByPrefix('singRIGHT', 'Sing Right', 24);
			...
			case 'bf-minus':
				var tex = Paths.getSparrowAtlas('characters/BOYFRIEND_1');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
