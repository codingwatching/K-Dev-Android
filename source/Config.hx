...
//optimization mode
    public function setoptimize(?value:Bool):Bool {
		if (save.data.isoptimize == null) save.data.isoptimize = false;
		
		save.data.isoptimize = !save.data.isoptimize;
		save.flush();
        return save.data.isoptimize;
	}

    public function getoptimize():Bool {
        if (save.data.isoptimize != null) return save.data.isoptimize;
        return false;
    }
